...
* `create_diffusion_index()`: compute a diffusion index from survey-style proportions of respondents increasing, decreasing, or unchanged. The methods the function can execute are:
  ...
  * [Conference Board](https://www.conference-board.org/data/bci/index.cfm?id=2180): encode each unit’s `pct_change` into 1 / 0.5 / 0 based on a threshold of .0005, then calculate the average and multiply it by 100.
